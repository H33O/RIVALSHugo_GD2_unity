...
public class KillerSpawnerEW : MonoBehaviour
{
    ...
    [Header("couleurkiller")]
    [SerializeField] private string Couleur1;
    [SerializeField] private string Couleur2;
    ...
    private void SpawnKiller()
    {
        ...
        GameObject killer = Instantiate(_killerPrefab, spawnPosition, transform.rotation * Quaternion.Euler(0, 180, 0));
    }
